...
const DepartmentList = () => {
    ...
    try {
      ...
      message.error(
        error.response?.data?.message ||
          `Error al ${editingDepartment ? 'actualizar' : 'crear'} el departamento`
      );
      console.error(error);
    }
  };
  ...
  const handleToggleStatus = async (department) => {
    try {
      ...
      message.success(
        `Departamento ${department.isActive ? 'desactivado' : 'activado'} exitosamente`
      );
      loadDepartments();
    } catch (error) {
      message.error('Error al cambiar el estado del departamento');
      console.error(error);
    }
  };
  ...
  const handleDelete = async (id) => {
    try {
      await departmentService.delete(id, false); // Soft delete
      message.success('Departamento desactivado exitosamente');
      loadDepartments();
    } catch (error) {
      ...
      render: (_, record) => (
        <Space>
          ...
          <Popconfirm
            ...
            description="Esta acción desactivará el departamento"
    ...
    <div className="space-y-4">
      <Card>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Gestión de departamentos de la organización
              </p>
            </div>
          </div>
          <Button
        ...
        <Table
          ...
          pagination={{
            ...
            showTotal: (total) => `Total: ${total} departamentos`,
          }}
      ...
      >
        ...
        >
          ...
          >
            <Input placeholder="Ej: Recursos Humanos" size="large" />
          </Form.Item>
